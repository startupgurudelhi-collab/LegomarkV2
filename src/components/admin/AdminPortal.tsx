...
const AdminPortalInner: React.FC<AdminPortalInnerProps> = ({ initialPath, onNavigateHome }) => {
  ...
  const getCurrentSection = (): AdminNavSection => {
    ...
    if (
      currentPath.includes('/admin/blog-series') ||
      currentPath.includes('/admin/blogseries') ||
      currentPath.includes('/admin/series')
    ) {
      return 'blog-series';
    }
    if (
    ...
    if (
      currentPath.includes('/admin/orphan-detector') ||
      currentPath.includes('/admin/orphandetector') ||
      currentPath.includes('/admin/orphan')
    ) {

...
export const AdminClientLogosCMS: React.FC = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      showToast(`Removed "${deletingLogo.name}".`);
    ...
    <div className="space-y-6">
      ...
      {deletingLogo && (
        <DeleteConfirmModal
          ...
          message={`Are you sure you want to permanently delete "${deletingLogo.name}" from the client logos database? Other logos will remain unaffected.`}
